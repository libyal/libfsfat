...
#if !defined( _FSFATTOOLS_GETOPT_H )
#define _FSFATTOOLS_GETOPT_H
...
typedef struct fsfattools_option fsfattools_option_t;

struct fsfattools_option
{
...
#define fsfattools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsfattools_getopt(
                  int argument_count,
...
void fsfattools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsfattools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsfattools_option_t *options,
      int number_of_options );

int fsfattools_getopt_get_options_string(
     const fsfattools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _FSFATTOOLS_GETOPT_H ) */
