...
#include "fsfattools_libfcache.h"
#include "fsfattools_libfdata.h"
 ...
 */
int fsfattools_output_initialize(
     int stdio_mode,
     libcerror_error_t **error )
{
	static char *function = "fsfattools_output_initialize";
 ...
 */
void fsfattools_output_copyright_fprint(
      FILE *stream )
{
	if( stream == NULL )
	{
 ...
 */
void fsfattools_output_version_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
 ...
 */
void fsfattools_output_version_detailed_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
