...
extern mount_handle_t *fsfatmount_mount_handle;
...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode FSFATTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags FSFATTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	FSFATTOOLS_UNREFERENCED_PARAMETER( share_mode )
	FSFATTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context FSFATTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes FSFATTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access FSFATTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options FSFATTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	FSFATTOOLS_UNREFERENCED_PARAMETER( security_context )
	FSFATTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	FSFATTOOLS_UNREFERENCED_PARAMETER( share_access )
	FSFATTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info FSFATTOOLS_ATTRIBUTE_UNUSED )
#else
...
#endif
{
	...
	FSFATTOOLS_UNREFERENCED_PARAMETER( file_info )
