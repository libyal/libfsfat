...
int mount_file_system_set_volume(
     mount_file_system_t *file_system,
     libfsfat_volume_t *fsfat_volume,
     libcerror_error_t **error )
{
	...
	file_system->fsfat_volume = fsfat_volume;
     ...
     libcerror_error_t **error )
{
	...
	*fsfat_volume = file_system->fsfat_volume;
...
int mount_file_system_get_file_entry_by_path(
     ...
     const system_character_t *path,
     size_t path_length,
     libfsfat_file_entry_t **fsfat_file_entry,
     libcerror_error_t **error )
{
