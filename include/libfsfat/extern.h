...
#if !defined( _LIBFSFAT_EXTERN_H )
#define _LIBFSFAT_EXTERN_H

/* To export functions from the libfsfat DLL define LIBFSFAT_DLL_EXPORT
 * To import functions from the libfsfat DLL define LIBFSFAT_DLL_IMPORT
