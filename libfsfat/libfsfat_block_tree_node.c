 ...
 */
int libfsfat_block_tree_node_initialize(
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_block_tree_node_free(
     libfsfat_block_tree_node_t **block_tree_node,
     ...
     libcerror_error_t **error )
{
	...
	static char *function                           = "libfsfat_block_tree_node_free";
	int result                                      = 1;
	...
	if( *block_tree_node != NULL )
	{
		...
		else
		{
			for( sub_node_index = 0;
			     sub_node_index < LIBFSFAT_BLOCK_TREE_NUMBER_OF_SUB_NODES;
			     sub_node_index++ )
			{
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_block_tree_node_get_sub_node_at_offset(
     libfsfat_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsfat_block_tree_node_t **sub_block_tree_node,
     libcerror_error_t **error )
{
	static char *function  = "libfsfat_block_tree_node_get_sub_node_at_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_block_tree_node_set_sub_node_at_offset(
     libfsfat_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsfat_block_tree_node_t *sub_block_tree_node,
     libcerror_error_t **error )
{
	static char *function  = "libfsfat_block_tree_node_set_sub_node_at_offset";
	off64_t sub_node_index = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_block_tree_node_get_leaf_value_at_offset(
     libfsfat_block_tree_node_t *block_tree_node,
     off64_t offset,
     ...
     libcerror_error_t **error )
{
	static char *function     = "libfsfat_block_tree_node_get_leaf_value_at_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_block_tree_node_set_leaf_value_at_offset(
     libfsfat_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsfat_block_descriptor_t *block_descriptor,
     libcerror_error_t **error )
{
	static char *function    = "libfsfat_block_tree_node_set_leaf_value_at_offset";
	off64_t leaf_value_index = 0;
