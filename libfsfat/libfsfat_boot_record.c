     ...
     libcerror_error_t **error )
{
	...
	boot_record->sectors_per_cluster_block = ( (fsfat_boot_record_fat12_t *) data )->sectors_per_cluster_block;
	...
	total_number_of_sectors = (uint32_t) total_number_of_sectors_16bit;
	...
	{
		total_number_of_sectors = total_number_of_sectors_32bit;
	}
