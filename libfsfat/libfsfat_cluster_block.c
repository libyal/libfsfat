 ...
 */
int libfsfat_cluster_block_initialize(
     libfsfat_cluster_block_t **cluster_block,
     size_t data_size,
     libcerror_error_t **error )
{
	static char *function = "libfsfat_cluster_block_initialize";
	...
	*cluster_block = memory_allocate_structure(
	...
	if( memory_set(
	     *cluster_block,
	     0,
	     sizeof( libfsfat_cluster_block_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_cluster_block_free(
     libfsfat_cluster_block_t **cluster_block,
     libcerror_error_t **error )
{
	static char *function = "libfsfat_cluster_block_free";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_cluster_block_read_file_io_handle(
     libfsfat_cluster_block_t *cluster_block,
     libbfio_handle_t *file_io_handle,
     off64_t file_offset,
     libcerror_error_t **error )
{
	static char *function = "libfsfat_cluster_block_read_file_io_handle";
