 ...
 */
void libfsfat_debug_print_file_system_state_flags(
 ...
 */
void libfsfat_debug_print_compatible_features_flags(
 ...
 */
void libfsfat_debug_print_incompatible_features_flags(
 ...
 */
void libfsfat_debug_print_read_only_compatible_features_flags(
 ...
 */
void libfsfat_debug_print_inode_flags(
 ...
 */
void libfsfat_debug_print_file_mode(
      uint16_t file_mode )
{
 ...
 */
const char *libfsfat_debug_print_error_handling_status(
 ...
 */
const char *libfsfat_debug_print_creator_operating_system(
 ...
 */
const char *libfsfat_debug_print_file_type(
             uint16_t file_type )
{
	switch( file_type )
	{
 ...
 */
int libfsfat_debug_print_posix_time_value(
     ...
     libcerror_error_t **error )
{
	...
	static char *function                 = "libfsfat_debug_print_posix_time_value";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_debug_print_guid_value(
     const char *function_name,
     const char *value_name,
     const uint8_t *byte_stream,
     size_t byte_stream_size,
     ...
     libcerror_error_t **error )
{
	...
	static char *function       = "libfsfat_debug_print_guid_value";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsfat_debug_print_utf8_string_value(
     const char *function_name,
     const char *value_name,
     const uint8_t *byte_stream,
     size_t byte_stream_size,
     libcerror_error_t **error )
{
	...
	static char *function      = "libfsfat_debug_print_utf8_string_value";
