...
#if !defined( _LIBFSFAT_LIBCTHREADS_H )
#define _LIBFSFAT_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBFSFAT )
#define HAVE_LIBFSFAT_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBFSFAT_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBFSFAT_LIBCTHREADS_H ) */
