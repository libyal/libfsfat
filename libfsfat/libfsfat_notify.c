...
{
	static char *function = "libfsfat_notify_set_stream";
...
int libfsfat_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsfat_notify_stream_open";
...
int libfsfat_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfsfat_notify_stream_close";
