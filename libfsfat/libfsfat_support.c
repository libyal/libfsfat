...
#include "libfsfat_libclocale.h"
#include "libfsfat_libcnotify.h"
#include "libfsfat_support.h"
...
const char *libfsfat_get_version(
             void )
{
	return( (const char *) LIBFSFAT_VERSION_STRING );
}
...
int libfsfat_get_access_flags_read(
     void )
{
	return( (int) LIBFSFAT_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfsfat_get_codepage";
...
int libfsfat_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsfat_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libfsfat_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libfsfat_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libfsfat_check_volume_signature_file_io_handle";
	...
	if( read_count != 2 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to read signature at offset: 510 (0x000001fe).",
		 function );
