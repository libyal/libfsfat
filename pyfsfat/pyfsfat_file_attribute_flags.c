...
PyTypeObject pyfsfat_file_attribute_flags_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsfat.file_attribute_flags",
	/* tp_basicsize */
	sizeof( pyfsfat_file_attribute_flags_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsfat_file_attribute_flags_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyfsfat file attribute flags object (wraps LIBFSFAT_FILE_ATTRIBUTE_FLAGS)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsfat_file_attribute_flags_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
     ...
     PyTypeObject *type_object )
{
	...
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_READ_ONLY );
#else
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_HIDDEN );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_HIDDEN );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_SYSTEM );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_SYSTEM );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_DIRECTORY );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_DIRECTORY );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_ARCHIVE );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_ARCHIVE );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_DEVICE );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_ATTRIBUTE_FLAG_DEVICE );
#endif
...
PyObject *pyfsfat_file_attribute_flags_new(
           void )
{
	pyfsfat_file_attribute_flags_t *definitions_object = NULL;
	static char *function                              = "pyfsfat_file_attribute_flags_new";

	definitions_object = PyObject_New(
	                      struct pyfsfat_file_attribute_flags,
	                      &pyfsfat_file_attribute_flags_type_object );
	...
	if( pyfsfat_file_attribute_flags_init(
...
{
	static char *function = "pyfsfat_file_attribute_flags_init";
      ...
      pyfsfat_file_attribute_flags_t *definitions_object )
{
	...
	static char *function       = "pyfsfat_file_attribute_flags_free";
