...
PySequenceMethods pyfsfat_file_entries_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfsfat_file_entries_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfsfat_file_entries_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfsfat_file_entries_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsfat.file_entries",
	/* tp_basicsize */
	sizeof( pyfsfat_file_entries_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsfat_file_entries_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfsfat_file_entries_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfsfat sequence and iterator object of file entries",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfsfat_file_entries_iter,
	/* tp_iternext */
	(iternextfunc) pyfsfat_file_entries_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsfat_file_entries_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfsfat_file_entries_new(
           ...
           int number_of_items )
{
	pyfsfat_file_entries_t *sequence_object = NULL;
	static char *function                   = "pyfsfat_file_entries_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyfsfat_file_entries_type_object );
...
{
	static char *function = "pyfsfat_file_entries_init";
      ...
      pyfsfat_file_entries_t *sequence_object )
{
	...
	static char *function       = "pyfsfat_file_entries_free";
...
Py_ssize_t pyfsfat_file_entries_len(
            pyfsfat_file_entries_t *sequence_object )
{
	static char *function = "pyfsfat_file_entries_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function       = "pyfsfat_file_entries_getitem";
...
PyObject *pyfsfat_file_entries_iter(
           pyfsfat_file_entries_t *sequence_object )
{
	static char *function = "pyfsfat_file_entries_iter";
...
{
	PyObject *file_entry_object = NULL;
	static char *function       = "pyfsfat_file_entries_iternext";
