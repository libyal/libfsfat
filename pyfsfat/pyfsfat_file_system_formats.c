...
PyTypeObject pyfsfat_file_system_formats_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsfat.file_system_format",
	/* tp_basicsize */
	sizeof( pyfsfat_file_system_formats_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsfat_file_system_formats_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyfsfat file system formats object (wraps LIBFSFAT_FILE_SYSTEM_FORMATS)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsfat_file_system_formats_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_SYSTEM_FORMAT_FAT16 );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_SYSTEM_FORMAT_FAT16 );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBFSFAT_FILE_SYSTEM_FORMAT_FAT32 );
#else
	value_object = PyInt_FromLong(
	                LIBFSFAT_FILE_SYSTEM_FORMAT_FAT32 );
#endif
...
/* Creates a new file system formats object
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfsfat_file_system_formats_new(
           void )
{
	pyfsfat_file_system_formats_t *definitions_object = NULL;
	static char *function                             = "pyfsfat_file_system_formats_new";

	definitions_object = PyObject_New(
	                      struct pyfsfat_file_system_formats,
	                      &pyfsfat_file_system_formats_type_object );
	...
	if( pyfsfat_file_system_formats_init(
...
/* Initializes a file system formats object
 * Returns 0 if successful or -1 on error
 */
int pyfsfat_file_system_formats_init(
     pyfsfat_file_system_formats_t *definitions_object )
{
	static char *function = "pyfsfat_file_system_formats_init";
...
/* Frees a file system formats object
 */
void pyfsfat_file_system_formats_free(
      pyfsfat_file_system_formats_t *definitions_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfsfat_file_system_formats_free";
