...
#include "fsfat_test_libclocale.h"
#include "fsfat_test_libuna.h"

/* Retrieves source as a narrow string
 * Returns 1 if successful or -1 on error
 */
int fsfat_test_get_narrow_source(
     const system_character_t *source,
     char *narrow_string,
     size_t narrow_string_size,
     libcerror_error_t **error )
{
	static char *function     = "fsfat_test_get_narrow_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int fsfat_test_get_wide_source(
     const system_character_t *source,
     wchar_t *wide_string,
     size_t wide_string_size,
     libcerror_error_t **error )
{
	static char *function   = "fsfat_test_get_wide_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int fsfat_test_system_string_copy_from_64_bit_in_decimal(
     const system_character_t *string,
     size_t string_size,
     uint64_t *value_64bit,
     libcerror_error_t **error )
{
	static char *function              = "fsfat_test_system_string_copy_from_64_bit_in_decimal";
 ...
 * Returns 1 if successful or -1 on error
 */
int fsfat_test_open_file_io_handle(
     libbfio_handle_t **file_io_handle,
     uint8_t *data,
     size_t data_size,
     libcerror_error_t **error )
{
	static char *function = "fsfat_test_open_file_io_handle";
 ...
 */
int fsfat_test_close_file_io_handle(
     libbfio_handle_t **file_io_handle,
     libcerror_error_t **error )
{
	static char *function = "fsfat_test_close_file_io_handle";
	int result            = 0;
