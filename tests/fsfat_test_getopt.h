...
#if !defined( _FSFAT_TEST_GETOPT_H )
#define _FSFAT_TEST_GETOPT_H
...
#define fsfat_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsfat_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSFAT_TEST_GETOPT_H ) */
