 ...
 */
int fsfat_test_tools_mount_path_string_copy_hexadecimal_to_integer_32_bit(
     void )
{
	...
	FSFAT_TEST_ASSERT_EQUAL_UINT32(
	 "value_32bit",
	 value_32bit,
	 (uint32_t) 0x2028 );
 ...
 * Returns 1 if successful or 0 if not
 */
int fsfat_test_tools_mount_path_string_copy_from_file_entry_path(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int fsfat_test_tools_mount_path_string_copy_to_file_entry_path(
     void )
{
#if defined( HAVE_WIDE_SYSTEM_CHARACTER )
	system_character_t expected_file_entry_path3[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', 0x2028, 't', 0 };
	system_character_t expected_file_entry_path4[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 't', 0 };
...
#else
	system_character_t expected_file_entry_path3[ 8 ] = { LIBFSFAT_SEPARATOR, 't', 'e', 0xe2, 0x80, 0xa8, 't', 0 };
	system_character_t expected_file_entry_path4[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 't', 0 };
	system_character_t path2[ 9 ]                     = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 'x', '0', '3', 't', 0 };
	system_character_t path3[ 15 ]                    = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 'U', '0', '0', '0', '0', '2', '0', '2', '8', 't', 0 };
	system_character_t path4[ 7 ]                     = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, ESCAPE_CHARACTER, 't', 0 };
	...
	system_character_t expected_file_entry_path1[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', 's', 't', 0 };
	system_character_t expected_file_entry_path2[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', 0x03, 't', 0 };
	system_character_t expected_file_entry_path5[ 6 ] = { LIBFSFAT_SEPARATOR, 't', 'e', LIBFSFAT_SEPARATOR, 't', 0 };
...
#endif
{
	...
	FSFAT_TEST_RUN(
	 ...
	 fsfat_test_tools_mount_path_string_copy_hexadecimal_to_integer_32_bit )

	FSFAT_TEST_RUN(
	 "mount_path_string_copy_from_file_entry_path",
	 fsfat_test_tools_mount_path_string_copy_from_file_entry_path )

	FSFAT_TEST_RUN(
	 "mount_path_string_copy_to_file_entry_path",
	 fsfat_test_tools_mount_path_string_copy_to_file_entry_path )
