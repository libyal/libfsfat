...
/* Tests the libfsfat_volume_get_last_mount_time function
 * Returns 1 if successful or 0 if not
 */
int fsfat_test_volume_get_last_mount_time(
     libfsfat_volume_t *volume )
{
	libcerror_error_t *error = NULL;
...
/* Tests the libfsfat_volume_get_last_written_time function
 * Returns 1 if successful or 0 if not
 */
int fsfat_test_volume_get_last_written_time(
     libfsfat_volume_t *volume )
{
	libcerror_error_t *error = NULL;
	int32_t posix_time       = 0;
...
#endif
{
	...
	if( result != 0 )
	{
		...
		FSFAT_TEST_RUN_WITH_ARGS(
		 "libfsfat_volume_get_last_mount_time",
		 fsfat_test_volume_get_last_mount_time,
		 volume );

		FSFAT_TEST_RUN_WITH_ARGS(
		 "libfsfat_volume_get_last_written_time",
		 fsfat_test_volume_get_last_written_time,
		 volume );
