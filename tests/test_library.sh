...
LIBRARY_TESTS="allocation_table block_descriptor block_tree block_tree_node boot_record directory directory_entry error file_entry io_handle name notify";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./fsfat_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libfsfat");
